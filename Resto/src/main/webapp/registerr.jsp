...
body {
  ...
  background: -webkit-linear-gradient(to top, #76b852, #6f8dc2);
  background: -moz-linear-gradient(to top, #76b852, #6f8dc2);
  background: -o-linear-gradient(to top, #76b852, #6f8dc2);
  background: linear-gradient(to top, #76b852, #6f8dc2);
